...
- **Глубокий анализ JavaScript** — продвинутое сканирование JS-кода в двух режимах: **Basic** (быстрая проверка эндпоинтов и безопасности) и **Deep** (полное сопоставление паттернов, извлечение учётных данных БД, анализ потока данных)
- **Картирование эндпоинтов** — автоматически извлекает REST/GraphQL эндпоинты, HTTP-методы, URL-паттерны и параметры из JavaScript-бандлов
...
└── main/
    ...
    │       │   ├── JavaScriptSecurityAnalyzer.java # Глубокий JS-анализ (картирование эндпоинтов, архитектура, схема БД)
