...
> **Версия:** 2.0.1 · **Автор:** Iaroslav Tsymbaliuk · **Должность:** Intern (2025–2026) @ r2u
...
- [Что нового в 2.0.1](#что-нового-в-201)
...
| Область | Изменение |
|---------|----------|
| **UI цепочки прокси** | Добавлена видимая панель цепочки прокси во вкладке Proxy |
| **Действия цепочки** | Добавлена кнопка `Build Chain` и обработчик инициализации цепочки |
| **Локализация (i18n)** | Диалог Proxy Chain Builder переведен для EN/IT/RU |
| **Стабильность** | Исправлены проблемы привязки FXML/контроллера, вызывавшие сбои при старте |
| **Версионирование** | Patch-повышение версии с `2.0.0` до `2.0.1` |
...
Исполняемый shaded JAR создается в корне проекта как `anibus-2.0.1.jar`.
